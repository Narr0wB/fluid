...
use vulkano::device::{Device, DeviceExtensions, physical::PhysicalDeviceType, DeviceCreateInfo, QueueCreateInfo, QueueFlags};
...
fn main() {
    ...
    let mut renderer = Renderer::init(instance, &event_loop, camera); 
